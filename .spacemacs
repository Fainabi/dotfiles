...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(;; python
     ;; (conda :variables conda-anaconda-home "/home/faina/.conda")
     ;; rust
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font `("Fira Code"
                               :size ,(if (not (getenv-internal "WITH_LEFTWM"))
                                         11.0
                                         15.0)
                               ;; :size 11.0
                               :weight normal
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ;; ligature-mode works globally, thus modify this variable to config before loading
  ;; it will automatically copy the ligature table for each of the elements, see ligature-composition-table
  (setq unicode-fonts-ligature-modes '(prog-mode coq-mode))

  ;; note that the command `helm-themes--load-them' seems to be lazy and only load when we type commands of others
  ;; thus not a prefer solution here. To reach this, use `(load-theme themename t)'
  (when (string-match "dark" (shell-command-to-string "gsettings get org.gnome.desktop.interface gtk-theme"))
    (setq dotspacemacs-themes '(spacemacs-dark tsdh-light)))
  ;; (helm-themes--load-theme "spacemacs-light"))
...
before packages are loaded."
  ...
  ;; run-time settings
  ;; org-mode load new pairs when open first new org file, thus needs a function that works
  (defun org-smartparens ()
    (interactive)
  ...
  ;; agda auto load
  ;; (add-hook 'agda-mode-hook #'agda2-mode)
  ...
  (add-hook 'lean4-mode-hook
            (lambda ()
              (progn
                ...
                (add-to-list 'lsp-file-watch-ignored-directories "[/\\\\]\\lake-packages\\'")
                (add-to-list 'lsp-file-watch-ignored-directories "[/\\\\]\\mathlib\\'")
                ;; (add-to-list 'lsp-file-watch-ignored-directories "[/\\\\]\\mathlib\\'")
              )))

  (setq-default lsp-keymap-prefix "s-i") ; inspecting
